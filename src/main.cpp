...
const string strMessageMagic = "Aurum Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Aurum", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "www.hacked.com/researcher-sees-major-gains-ahead-bitcoin-silver-gold";
        CTransaction txNew;
        txNew.nTime = 1489460400;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1489460400;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        //block.nBits = 0x1e0ffff0;
        block.nNonce   = 1185256;
        ...
        assert(block.hashMerkleRoot == uint256("0x20321c604179e65fa66ca8cde9d5e60470ce3bf3e013a8b87be0766ea2d9cc7d"));
...
unsigned char pchMessageStart[4] = { 0xc5, 0x32, 0xa3, 0xbc };
